// tableOrderInner = document.querySelector('table__order-inner');
...
window.addEventListener('click', function (event) {
    ...
    //     `
    //     tableOrderInner.insertAdjacentHTML('beforeend',cartItemHtml )
    ...
    if (event.target.hasAttribute('data-toCart')) {
        ...
        `
        tableOrderInner.insertAdjacentHTML('beforeend',cartItemHtml1 )
